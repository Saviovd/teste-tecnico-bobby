<template>
    <div class="logout-button-container absolute bottom-4 left-0 w-full flex justify-center">
        <button @click="handleLogout" class="p-4 text-indigo-400 transition-transform duration-300 ease-in-out">
            <svg xmlns="http://www.w3.org/2000/svg" class="fill-blue-500 w-10 h-10 hover:fill-zinc-200"
